...
export const REPROJECAO_REGRAS_FIXAS: RegraReprojecaoRow[] = [
  ...
  },
  {
    ...
    descricao: 'Venda ficou entre 15% e 69,99% acima da projecao. Manter o mes seguinte e aplicar, a partir do mes subsequente, a media entre a projecao original e a corrigida pela variacao.',
  ...
  },
  {
    ...
    maxAtendido: 114.99,
    acao: 'MANTER',
    descricao: 'Venda ficou dentro da faixa estavel, de 30% abaixo ate 14,99% acima do previsto. Manter a projecao.',
